...
proc create_root_design { parentCell } {
  ...
  # Create instance: shift_addr_0, and set properties
  set block_name shift_addr
  set block_cell_name shift_addr_0
  if { [catch {set shift_addr_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $shift_addr_0 eq "" } {
...
\
  ...
  set current_dir [pwd]
  set coe_program_path [string cat $current_dir "/src/sw/mem_files/program.coe"]
  ...
  # Create instance: shift_addr_2, and set properties
  set block_name shift_addr
  set block_cell_name shift_addr_2
  if { [catch {set shift_addr_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $shift_addr_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: shift_addr_3, and set properties
  set block_name shift_addr
  set block_cell_name shift_addr_3
  if { [catch {set shift_addr_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $shift_addr_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: reboot_riscv_0, and set properties
  set block_name reboot_riscv
  set block_cell_name reboot_riscv_0
  if { [catch {set reboot_riscv_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $reboot_riscv_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: blk_mem_gen_2, and set properties
  set coe_data_path [string cat $current_dir "/src/sw/mem_files/example.coe"]
  ...
  # Create instance: shift_addr_1, and set properties
  set block_name shift_addr
  set block_cell_name shift_addr_1
  if { [catch {set shift_addr_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $shift_addr_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ahblite_axi_bridge_0_M_AXI [get_bd_intf_pins ahblite_axi_bridge_0/M_AXI] [get_bd_intf_pins axi_bram_ctrl_2/S_AXI]
  connect_bd_intf_net -intf_net ahblite_axi_bridge_1_M_AXI [get_bd_intf_pins ahblite_axi_bridge_1/M_AXI] [get_bd_intf_pins axi_bram_ctrl_3/S_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins reboot_riscv_0/s_axi_control]

  # Create port connections
  connect_bd_net -net Net  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hready_out] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hready_in] \
  [get_bd_pins riscv_top_ahb3lite_0/ins_HREADY]
  connect_bd_net -net Net1  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hready_out] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hready_in] \
  [get_bd_pins riscv_top_ahb3lite_0/dat_HREADY]
  connect_bd_net -net ahblite_axi_bridge_0_s_ahb_hrdata  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hrdata] \
  [get_bd_pins riscv_top_ahb3lite_0/ins_HRDATA]
  connect_bd_net -net ahblite_axi_bridge_0_s_ahb_hresp  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hresp] \
  [get_bd_pins riscv_top_ahb3lite_0/ins_HRESP]
  connect_bd_net -net ahblite_axi_bridge_1_s_ahb_hrdata  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hrdata] \
  [get_bd_pins riscv_top_ahb3lite_0/dat_HRDATA]
  connect_bd_net -net ahblite_axi_bridge_1_s_ahb_hresp  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hresp] \
  [get_bd_pins riscv_top_ahb3lite_0/dat_HRESP]
  ...
  connect_bd_net -net axi_bram_ctrl_1_bram_rst_a  [get_bd_pins axi_bram_ctrl_1/bram_rst_a] \
  [get_bd_pins blk_mem_gen_2/rstb]
  connect_bd_net -net axi_bram_ctrl_1_bram_we_a  [get_bd_pins axi_bram_ctrl_1/bram_we_a] \
  [get_bd_pins blk_mem_gen_2/web]
  connect_bd_net -net axi_bram_ctrl_1_bram_wrdata_a  [get_bd_pins axi_bram_ctrl_1/bram_wrdata_a] \
  [get_bd_pins blk_mem_gen_2/dinb]
  ...
  [get_bd_pins shift_addr_3/in_addr]
  connect_bd_net -net axi_bram_ctrl_3_bram_clk_a  [get_bd_pins axi_bram_ctrl_3/bram_clk_a] \
  [get_bd_pins blk_mem_gen_2/clka]
  connect_bd_net -net axi_bram_ctrl_3_bram_en_a  [get_bd_pins axi_bram_ctrl_3/bram_en_a] \
  [get_bd_pins blk_mem_gen_2/ena]
  connect_bd_net -net axi_bram_ctrl_3_bram_rst_a  [get_bd_pins axi_bram_ctrl_3/bram_rst_a] \
  [get_bd_pins blk_mem_gen_2/rsta]
  connect_bd_net -net axi_bram_ctrl_3_bram_we_a  [get_bd_pins axi_bram_ctrl_3/bram_we_a] \
  [get_bd_pins blk_mem_gen_2/wea]
  connect_bd_net -net axi_bram_ctrl_3_bram_wrdata_a  [get_bd_pins axi_bram_ctrl_3/bram_wrdata_a] \
  [get_bd_pins blk_mem_gen_2/dina]
  ...
  connect_bd_net -net blk_mem_gen_2_doutb  [get_bd_pins blk_mem_gen_2/doutb] \
  [get_bd_pins axi_bram_ctrl_1/bram_rddata_a]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hclk] \
  ...
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HADDR  [get_bd_pins riscv_top_ahb3lite_0/dat_HADDR] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_haddr]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HBURST  [get_bd_pins riscv_top_ahb3lite_0/dat_HBURST] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hburst]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HPROT  [get_bd_pins riscv_top_ahb3lite_0/dat_HPROT] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hprot]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HSIZE  [get_bd_pins riscv_top_ahb3lite_0/dat_HSIZE] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hsize]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HTRANS  [get_bd_pins riscv_top_ahb3lite_0/dat_HTRANS] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_htrans]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HWDATA  [get_bd_pins riscv_top_ahb3lite_0/dat_HWDATA] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hwdata]
  connect_bd_net -net riscv_top_ahb3lite_0_dat_HWRITE  [get_bd_pins riscv_top_ahb3lite_0/dat_HWRITE] \
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hwrite]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HADDR  [get_bd_pins riscv_top_ahb3lite_0/ins_HADDR] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_haddr]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HBURST  [get_bd_pins riscv_top_ahb3lite_0/ins_HBURST] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hburst]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HPROT  [get_bd_pins riscv_top_ahb3lite_0/ins_HPROT] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hprot]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HSIZE  [get_bd_pins riscv_top_ahb3lite_0/ins_HSIZE] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hsize]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HTRANS  [get_bd_pins riscv_top_ahb3lite_0/ins_HTRANS] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_htrans]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HWDATA  [get_bd_pins riscv_top_ahb3lite_0/ins_HWDATA] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hwdata]
  connect_bd_net -net riscv_top_ahb3lite_0_ins_HWRITE  [get_bd_pins riscv_top_ahb3lite_0/ins_HWRITE] \
  [get_bd_pins ahblite_axi_bridge_0/s_ahb_hwrite]
  ...
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hresetn] \
  ...
  connect_bd_net -net shift_addr_0_out_addr  [get_bd_pins shift_addr_0/out_addr] \
  [get_bd_pins blk_mem_gen_1/addrb]
  connect_bd_net -net shift_addr_1_out_addr  [get_bd_pins shift_addr_1/out_addr] \
  [get_bd_pins blk_mem_gen_2/addrb]
  connect_bd_net -net shift_addr_2_out_addr  [get_bd_pins shift_addr_2/out_addr] \
  ...
  [get_bd_pins ahblite_axi_bridge_1/s_ahb_hsel]
  ...
  assign_bd_address -offset 0x40008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs reboot_riscv_0/s_axi_control/reg0] -force
