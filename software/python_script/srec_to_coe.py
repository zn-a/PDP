...
def main():
    ...
    # split the rom in 4-byte chunks and emit as binascii 
    with open(args.output, "wb") as outfile:
        outfile.write(b"memory_initialization_radix=16;\n")
        outfile.write(b"memory_initialization_vector=")	
        i = 0
        while i < len(rom):
            chunk = rom[i : i + 4]
            i += 4
